...
INSERT INTO meeple_users (user_name, full_name, password)
VALUES
  (
    'jason',
    'Jason Stankevich',
...
INSERT INTO meeple_boardgames (title, tagline, description, bg_type, num_players)
VALUES
  (
    'Ticket to Ride',
...
INSERT INTO meeple_collection (user_id, bgame_id, rating, num_plays)
VALUES
  (
    '1',
    '1',
